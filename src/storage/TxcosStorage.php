...
class TxcosStorage extends Storage
{
    ...
    protected function initialize()
    {
        ...
        $this->prefix = sysconf('storage.txcos_url');
        // 计算链接前缀
    ...
    {
        return [
            'cos.ap-beijing-1.myqcloud.com'     => '北京一区',
            'cos.ap-beijing.myqcloud.com'       => '北京',
            'cos.ap-nanjing.myqcloud.com'       => '南京',
            'cos.ap-shanghai.myqcloud.com'      => '上海',
            'cos.ap-guangzhou.myqcloud.com'     => '广州',
            'cos.ap-chengdu.myqcloud.com'       => '成都',
            'cos.ap-chongqing.myqcloud.com'     => '重庆',
            'cos.ap-shenzhen-fsi.myqcloud.com'  => '深圳金融',
            'cos.ap-shanghai-fsi.myqcloud.com'  => '上海金融',
            'cos.ap-beijing-fsi.myqcloud.com'   => '北京金融',
            'cos.ap-hongkong.myqcloud.com'      => '中国香港',
            'cos.ap-singapore.myqcloud.com'     => '新加坡',
            'cos.ap-mumbai.myqcloud.com'        => '孟买',
            'cos.ap-seoul.myqcloud.com'         => '首尔',
            'cos.ap-bangkok.myqcloud.com'       => '曼谷',
            'cos.ap-tokyo.myqcloud.com'         => '东京',
            'cos.na-siliconvalley.myqcloud.com' => '硅谷',
            'cos.na-ashburn.myqcloud.com'       => '弗吉尼亚',
            'cos.na-toronto.myqcloud.com'       => '多伦多',
            'cos.eu-frankfurt.myqcloud.com'     => '法兰克福',
            'cos.eu-moscow.myqcloud.com'        => '莫斯科	',
        ];
    }
